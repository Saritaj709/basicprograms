/*****************************************************************************
 * Compilation:  javac -d bin NoOfBinarySearchTree.java
 *  Execution:    java -cp bin com.bridgelabz.util.NoOfBinarySearchTree.java File
 * Purpose:to read the node value and to find the total no. of possible 
 * binary search trees with the given no. of nodes
 *   @author  Sarita
 *  @version 1.0
 *  @since  05-27-2018         
 */
